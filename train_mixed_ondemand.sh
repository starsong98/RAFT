#!/bin/bash
mkdir -p checkpoints
#CUDA_VISIBLE_DEVICES=1 python -u train.py --name raft-chairs-ondemand-msp --stage chairs --validation chairs --gpus 0 --num_steps 120000 --batch_size 8 --lr 0.00025 --image_size 368 496 --wdecay 0.0001 --mixed_precision --alternate_corr
CUDA_VISIBLE_DEVICES=0 python -u train.py --name raft-chairs-ondemand-ccmr --stage chairs --validation chairs --gpus 0 --num_steps 120000 --batch_size 8 --lr 0.00025 --image_size 368 496 --wdecay 0.0001 --mixed_precision --alternate_corr
